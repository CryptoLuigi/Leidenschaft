...
class LevelingSlash(commands.Cog):
    ...
    async def setbg(self, interaction: Interaction, *, url: str):
        ...
        await interaction.send(ephemeral=True, content="Background image has been updated")
    ...
    async def resetbg(self, interaction: Interaction):
        ...
        await interaction.send(ephemeral=True, content="Background image has been set to default")
    ...
    async def resetcolor(self, interaction: Interaction):
        ...
        await set_text_color(self.bot, interaction.user.id, interaction.guild.id, color="white", color2="grey", color3="white")
        await interaction.send(ephemeral=True, content="Text color has been set to default")
    ...
    async def setfont(self, interaction: Interaction):
        ...
        async def my_callback(interaction):
            if int(select.values[0]) == 1:
                ...
                await interaction.send(ephemeral=True, content="Text font has been updated", )
    ...
    async def add_server_bg(self, interaction: Interaction, *, url: str):
        ...
        await interaction.send(ephemeral=True, content="Background image has been added")
    ...
    async def remove_server_bg(self, interaction: Interaction, *, name: str):
        ...
        await interaction.send(ephemeral=True, content="Background image has been deleted")
